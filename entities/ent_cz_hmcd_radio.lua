...
if SERVER then
    hook.Add("OnEntityCreated", "asdasdasd", function( ent )
        if ent:GetClass() == "ent_cz_hmcd_radio" then
...
if SERVER then
    ...
    net.Receive("RadioURLInput", function(len, ply)
        ...
        if ent:GetClass() != "ent_cz_hmcd_radio" or (ent:GetPos():Distance(ply:EyePos()) > 75) then return end
