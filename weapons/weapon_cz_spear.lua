...
local function tape()
    RunConsoleCommand("cz_tape_knife_spear")
end

if SERVER then
    concommand.Add("cz_tape_knife_spear",function(ply)
        local organism = ply.organism
        if not organism.otrub and ply:HasWeapon("weapon_cz_spear") and ply:HasWeapon("weapon_ducttape") and ply:HasWeapon("weapon_pocketknife") then
            ply:GetWeapon("weapon_cz_spear"):Remove()
            ply:GetWeapon("weapon_ducttape"):Remove()
            ply:GetWeapon("weapon_pocketknife"):Remove()
            ply:Give("weapon_cz_spear_knife")
