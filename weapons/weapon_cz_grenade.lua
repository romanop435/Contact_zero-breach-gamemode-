...
if SERVER then
	util.AddNetworkString("cz_started_attack")
	util.AddNetworkString("cz_started_spoon")
else
	net.Receive("cz_started_attack",function()
		net.ReadEntity().startedattack = CurTime()
	end)
	net.Receive("cz_started_spoon",function()
