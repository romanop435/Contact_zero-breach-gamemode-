    ...
    net.Receive("SuitCostumeSelected", function(len, ply)
        ...
        if IsValid(wep) and wep:GetClass() == "weapon_traitor_suit" then
            ...
            if selectedCostume then
                ...
                local newIdentity = {
                    Gender = selectedCostume.Gender,
                    Name = selectedCostume.Name,
                    Model = selectedCostume.Model,
                    Color = selectedCostume.Color,
                    ClothesStyle = selectedCostume.ClothesStyle,
                    Attachments = selectedCostume.Attachments or {}
                }
                
                ApplyForceAppearance(ply, newIdentity)
