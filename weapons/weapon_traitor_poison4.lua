...
local whitelist = {
	...
	["weapon_hatchet"] = true,
	["weapon_cz_axe"] = true,
	["weapon_cz_bottlebroken"] = true,
	["weapon_cz_crowbar"] = true,
	["weapon_cz_shuriken"] = true,
	["weapon_cz_spear_knife"] = true,
	["weapon_cz_spear_pro"] = true,
...
if SERVER then
	...
	net.Receive("choose_poison", function(len, ply)
		...
		if ply:GetActiveWeapon():GetClass() == "weapon_traitor_poison4" and wep:GetOwner() == ply and whitelist[wep:GetClass()] then
			ply:GetActiveWeapon():DoPoison(wep)
		end
	end)
end
